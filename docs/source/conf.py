...
def generate_apidocs(*args):
    ...
    module_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "fusionlab"))
...
html_theme_options = {
    "external_links": [{"url": "https://github.com/taipingeric/fusionlab", "name": "Tutorials"}],
...
html_context = {
    "github_user": "taipingeric",
    "github_repo": "fusionlab",
    "github_version": "dev",
    "doc_path": "docs/",
    "conf_py_path": "/docs/",
    "VERSION": version,
